        ...
        <div className='color-pick-box'>
          <div className='color-pick'>
            ...
            <input
              ...
              name='left'
              value={leftColor}
              onChange={(e) => setLeftColor(e.currentTarget.value)}
            />
          </div>
          <div className='color-pick'>
            ...
            <input
              ...
              name='mid'
              value={midColor}
              onChange={(e) => setMidColor(e.currentTarget.value)}
            />
          </div>
          <div className='color-pick'>
            ...
            <input
              ...
              name='right'
              value={rightColor}
              onChange={(e) => setRightColor(e.currentTarget.value)}
            />
          </div>
        </div>
        <div
          ...
          style={{
            background: `linear-gradient(0.25turn,${leftColor}, ${midColor}, ${rightColor})`
          }}
        ></div>
